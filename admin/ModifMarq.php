...
if(!empty($_POST)){
  ...
  $req = $con->prepare('UPDATE marque SET nomMarq = ? WHERE idMarq= ?');
  $req->execute(array($label,$_GET['id']));
...
<div class="form-control ">
    ...
    <input type="text" id="label" name="label" value="<?=$prods['nomMarq']?>" >
