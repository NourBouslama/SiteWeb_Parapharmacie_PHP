...
if(!empty($_POST)){
  ...
  $req = $con->prepare('insert into produit (label,id_categ,id_marque,imageProd,description,nouvprix,stock) values (?, ?, ?, ?, ?, ?, ?)');
  $req->execute(array($label,$categorie_id,$marque_id,$image,$description,$prix,$stock));
