			...
			<div class="table-data">
                ...
                ?>
							<tr>
                                ...
                                <td style="font-size: 15px;"><?= $row['nom']?></td>
                                <td style="font-size: 15px;"><?= $row['mail']?></td>
								<td><?= $row['adresse']?></td>
								<td><?= $row['mdp']?></td>
                                <td> <button  onclick="window.location.href='suppClient.php?id=<?=$row['idU']?>'"> <i class="bx bx-trash"></i> </button> </td>
							</tr>
                            <?php endforeach;?>
						</tbody>
					</table>
